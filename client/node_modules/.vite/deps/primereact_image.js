...
import {
  TimesIcon
} from "./chunk-ZCOOQOKC.js";
import {
  EyeIcon
} from "./chunk-C2EYJ3DQ.js";
import {
  CSSTransition
} from "./chunk-RXXHUPJG.js";
import "./chunk-RWJ2PLW7.js";
import {
  Portal
} from "./chunk-ODH5TXO4.js";
import {
  IconBase
} from "./chunk-IQVF2CG3.js";
import {
  ComponentBase,
  DomHandler,
...
var RefreshIcon = React.memo(React.forwardRef(function(inProps, ref) {
...
var SearchMinusIcon = React2.memo(React2.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var SearchPlusIcon = React3.memo(React3.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var UndoIcon = React4.memo(React4.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var DownloadIcon = React5.memo(React5.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var Image = React5.memo(React5.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React5.useContext(PrimeReactContext);
  var props = ImageBase.getProps(inProps, context);
  var _React$useState = React5.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), maskVisibleState = _React$useState2[0], setMaskVisibleState = _React$useState2[1];
  var _React$useState3 = React5.useState(false), _React$useState4 = _slicedToArray(_React$useState3, 2), previewVisibleState = _React$useState4[0], setPreviewVisibleState = _React$useState4[1];
  var _React$useState5 = React5.useState(0), _React$useState6 = _slicedToArray(_React$useState5, 2), rotateState = _React$useState6[0], setRotateState = _React$useState6[1];
  var _React$useState7 = React5.useState(1), _React$useState8 = _slicedToArray(_React$useState7, 2), scaleState = _React$useState8[0], setScaleState = _React$useState8[1];
  var elementRef = React5.useRef(null);
  var imageRef = React5.useRef(null);
  var maskRef = React5.useRef(null);
  var previewRef = React5.useRef(null);
  var previewButton = React5.useRef(null);
  ...
  var createPreview = function createPreview2() {
    ...
    if (props.preview) {
      return React5.createElement("button", buttonProps, content);
    }
    return null;
  };
  var createElement6 = function createElement7() {
    ...
    var downloadIcon = IconUtils.getJSXIcon(props.downloadIcon || React5.createElement(DownloadIcon, null), _objectSpread({}, downloadIconProps), {
      props
    });
    var rotateRightIcon = IconUtils.getJSXIcon(props.rotateRightIcon || React5.createElement(RefreshIcon, null), _objectSpread({}, rotateRightIconProps), {
      props
    });
    var rotateLeftIcon = IconUtils.getJSXIcon(props.rotateLeftIcon || React5.createElement(UndoIcon, null), _objectSpread({}, rotateLeftIconProps), {
      props
    });
    var zoomOutIcon = IconUtils.getJSXIcon(props.zoomOutIcon || React5.createElement(SearchMinusIcon, null), _objectSpread({}, zoomOutIconProps), {
      props
    });
    var zoomInIcon = IconUtils.getJSXIcon(props.zoomInIcon || React5.createElement(SearchPlusIcon, null), _objectSpread({}, zoomInIconProps), {
      props
    });
    var closeIcon = IconUtils.getJSXIcon(props.closeIcon || React5.createElement(TimesIcon, null), _objectSpread({}, closeIconProps), {
      props
    });
    ...
    return React5.createElement("div", maskProps, React5.createElement("div", toolbarProps, downloadable && React5.createElement("button", downloadButtonProps, downloadIcon), React5.createElement("button", rotateRightButtonProps, rotateRightIcon), React5.createElement("button", rotateLeftButtonProps, rotateLeftIcon), React5.createElement("button", zoomOutButtonProps, zoomOutIcon), React5.createElement("button", zoomInButtonProps, zoomInIcon), React5.createElement("button", closeButtonProps, closeIcon)), React5.createElement(CSSTransition, _extends5({
      nodeRef: previewRef
    }, transitionProps), React5.createElement("div", previewContainerProps, React5.createElement("img", _extends5({
      alt: alt2
    }, previewProps)))));
  };
  ...
  var icon = props.indicatorIcon || React5.createElement(EyeIcon, iconProp);
  ...
  var image = props.src && React5.createElement("img", _extends5({}, imageProp, {
    alt
  }));
  ...
  return React5.createElement("span", rootProps, image, preview2, maskVisibleState && React5.createElement(Portal, {
    element,
