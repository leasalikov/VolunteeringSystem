...
var EyeSlashIcon = React.memo(React.forwardRef(function(inProps, ref) {
...
var IconField = import_react.default.memo(import_react.default.forwardRef(function(inProps, ref) {
  ...
  return import_react.default.createElement("div", _extends2({}, rootProps, {
    ref: elementRef
  }), props.children);
}));
...
var InputIcon = import_react.default.memo(import_react.default.forwardRef(function(inProps, ref) {
  ...
  return import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement("span", _extends2({}, rootProps, {
    ref: elementRef
  }), props.children));
}));
...
var Password = React2.memo(React2.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  ...
  var _React$useState = React2.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), overlayVisibleState = _React$useState2[0], setOverlayVisibleState = _React$useState2[1];
  var _React$useState3 = React2.useState(null), _React$useState4 = _slicedToArray(_React$useState3, 2), meterState = _React$useState4[0], setMeterState = _React$useState4[1];
  var _React$useState5 = React2.useState(promptLabel), _React$useState6 = _slicedToArray(_React$useState5, 2), infoTextState = _React$useState6[0], setInfoTextState = _React$useState6[1];
  ...
  var _React$useState9 = React2.useState(false), _React$useState10 = _slicedToArray(_React$useState9, 2), unmaskedState = _React$useState10[0], setUnmaskedState = _React$useState10[1];
  var elementRef = React2.useRef(null);
  var overlayRef = React2.useRef(null);
  var inputRef = React2.useRef(props.inputRef);
  var mediumCheckRegExp = React2.useRef(new RegExp(props.mediumRegex));
  var strongCheckRegExp = React2.useRef(new RegExp(props.strongRegex));
  ...
  var createIcon = function createIcon2() {
    ...
    if (unmaskedState) {
      icon2 = props.hideIcon || React2.createElement(EyeSlashIcon, hideIconProps);
    } else {
      icon2 = props.showIcon || React2.createElement(EyeIcon, showIconProps);
    }
  ...
  var createPanel = function createPanel2() {
    ...
    var content = props.content ? ObjectUtils.getJSXElement(props.content, props) : React2.createElement(React2.Fragment, null, React2.createElement("div", meterProps, React2.createElement("div", meterLabelProps)), React2.createElement("div", infoProps, infoTextState));
    ...
    var panel3 = React2.createElement(CSSTransition, _extends2({
      nodeRef: overlayRef
  ...
  var input2 = React2.createElement(InputText, inputTextProps);
  if (icon) {
    input2 = React2.createElement(IconField, {
      className: cx("iconField"),
      pt: ptm("iconField"),
      __parentMetadata: {
        parent: metaData
      }
    }, input2, React2.createElement(InputIcon, null, icon));
  }
  return React2.createElement("div", rootProps, input2, panel2);
}));
